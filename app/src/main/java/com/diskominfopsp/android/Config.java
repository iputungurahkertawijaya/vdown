package com.diskominfopsp.android;
...
public class Config {
    ...
    public static final Object[] TITLES = new String[]{"painan"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://diskominfo-padangsidimpuan.my.id/app"};
    ...
    public static final String[] OPEN_OUTSIDE_WEBVIEW = new String[]{"market://","play.google.com", "plus.google.com", "mailto:", "tel:", "vid:", "geo:", "whatsapp:", "sms:", "intent://","api.whatsapp.com","google.co.id/maps","google.com/maps","twitter.com","facebook.com","instagram.com","youtube.com","https://diskominfo-padangsidimpuan.my.id/cetak/"};
